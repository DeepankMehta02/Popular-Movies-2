    ...
    public class FetchTrailer extends AsyncTask<String, Void, Trailer[]> {
        ...
        protected Trailer[] doInBackground(String... params) {
            ...
            try {
                ...
                trailerData = NetworkUtility.getTrailerJson(DetailsActivity.this, response);
                return trailerData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
        ...
        protected void onPostExecute(Trailer[] trailers) {
            if (trailers != null) {
                mTrailerAdapter = new TrailerAdapter(trailers, DetailsActivity.this);
                mRecyclerViewTrailer.setAdapter(mTrailerAdapter);
            } else {
    ...
    public class FetchReview extends AsyncTask<String, Void, Review[]> {
        ...
        protected Review[] doInBackground(String... params) {
            ...
            try {
                ...
                reviewData = NetworkUtility.getReviewJson(DetailsActivity.this, response);
                return reviewData;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
